...
val unlockPremiumPatch = bytecodePatch(
    ...
    execute {
        ...
        OpenHttpUrlConnectionFingerprint.method.apply {
            ...
            val xAndroidCertIndex = OpenHttpUrlConnectionFingerprint.stringMatches.first().index
            
            // 2. Scan forward from that instruction to find the first call to HttpURLConnection.addRequestProperty
            val addRequestPropertyInstruction = instructions
                ...
                .first { instr ->
                    ...
                    ((instr as? ReferenceInstruction)?.reference as? MethodReference)?.name == "addRequestProperty"
                }
